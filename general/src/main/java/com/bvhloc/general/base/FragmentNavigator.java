...
public class FragmentNavigator {
     ...
     * @param fragment
     */
    public void replaceCurrent(final Fragment fragment) {
        mFragmentManager.popBackStackImmediate();
        goTo(fragment);
    }


    public void replace(final Fragment fragment, String currentTag) {
        FragmentTransaction transaction = mFragmentManager.beginTransaction();
        transaction.addToBackStack(getTag(fragment));
        transaction.replace(mDefaultContainer, fragment, currentTag);
        transaction.setTransition(FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        transaction.commit();
        mFragmentManager.executePendingTransactions();
    }
