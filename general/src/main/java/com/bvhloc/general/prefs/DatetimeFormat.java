...
public final class DatetimeFormat {
    ...
    public static final SimpleDateFormat APP_DATETIME_FORMAT = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
    public static final SimpleDateFormat ID_DATETIME_FORMAT = new SimpleDateFormat("yyyyMMddHHmmssSSS");
